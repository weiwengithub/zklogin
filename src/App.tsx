...
import {CoinBalance, SuiClient} from "@onelabs/sui/client";
...
const suiClient = new SuiClient({ url: OCT_TESTNET_URL });
...
function App() {
  ...
  const [addressBalance, setAddressBalance] = useState<undefined | CoinBalance>(undefined);
  ...
  const requestFaucet = async () => {
    ...
    try {
      ...
      await axios.post(OCT_DEVNET_FAUCET, {
        FixedAmountRequest: {
          ...
          <Stack spacing={2}>
            ...
            >
              <SyntaxHighlighter
                ...
                style={oneDark}
              >
                {`import { generateRandomness } from '@oenchain/sui/zklogin';
        ...
        {activeStep === 4 && (
          <Stack spacing={2}>
            ...
            <SyntaxHighlighter
              ...
              style={oneDark}
            >
              {`import { jwtToAddress } from "@onechain/sui/zklogin";
        ...
        {activeStep === 5 && (
          <Stack spacing={2}>
            ...
            <SyntaxHighlighter
              ...
              style={oneDark}
            >
              {`import { getExtendedEphemeralPublicKey } from "@onechain/sui/zklogin";
            ...
            <div className="card">
              <LoadingButton
                ...
                onClick={async () => {
                  try {
                    ...
                    const [coin] = txb.splitCoins(txb.gas, [MIST_PER_SUI / 100n]);
                    txb.transferObjects(
                      [coin],
              ...
              {executeDigest && (
                <Alert severity="success" sx={{ mt: "12px" }}>
                  ...
                  >
                    <a
                      href={`https://onescan.cc/testnet/transactionBlocksDetail?digest=${executeDigest}`}
                      target="_blank"
                    >
                      {executeDigest}
                    </a>
